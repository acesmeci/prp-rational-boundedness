...
add("Schubert (1999)","1","Two-alt, order 1-2 (n=7)",S,[700,660,500,450],540,"F",['suborder'])
add("Schubert (1999)","1","Two-alt, order 2-1 (n=7)",S,[710,650,480,440],540,"F",['suborder'])
add("Schubert (1999)","1","One-alt, order 1-2 (n=7)",S,[595,560,400,220],475,"F",['simple_rt','suborder'])
add("Schubert (1999)","1","One-alt, order 2-1 (n=7)",S,[595,560,400,280],475,"F",['simple_rt','suborder'])
